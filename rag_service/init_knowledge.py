...
knowledge_base = [
    ...
    {
        "text": "如何统计每种报警性质的数量？系统支持查询各报警性质的具体数量，方便了解报警分布情况。",
        "metadata": {"category": "报警功能", "source": "系统文档"}
    },
    {
        "text": "报警性质数量统计功能可以查看每种报警性质有多少条记录，帮助分析报警类型的主要分布。",
        "metadata": {"category": "报警功能", "source": "系统文档"}
    },
    {
        "text": "如何查看特定报警性质的数量？系统支持查询指定报警性质（如自动应答）的具体数量，方便了解某种报警性质的详细分布。",
        "metadata": {"category": "报警功能", "source": "系统文档"}
    },
